...
const harmandeep = {
  ...
  nextGoal  : "🚀 Launch my first real project this month!"
};
```
...
```python
class HarmandeepSingh:
    def __init__(self):
        self.status    = "1st Year B.Tech CSE @ LPU"
        self.learning  = ["React.js", "Node.js", "Backend APIs"]
        self.building  = "🔨 First Full-Stack Project (Coming Soon!)"
...
```
📁 projects/
├── 🔨 project_01  [IN PROGRESS — launching this month!]
├── 🔜 project_02  [PLANNED]
└── 🔜 project_03  [PLANNED]
